...
export default () => {
    return (
        <>
            ...
            <CollectionBodyParagraph>
                It’s going to take a lot of work to get there though. We’d like to highlight a few creators, websites, and organizations who are working to advance Brave’s vision.
            </CollectionBodyParagraph>
            <CollectionBodyParagraph>
                First up are some projects that were an inspiration for <CollectionBodyParagraphBoldSpan>givebat</CollectionBodyParagraphBoldSpan> itself. These are some fantastic places to see all the cool new sites and creators adopting Brave Rewards. You’ll see both of these projects’ creators hanging around in the Telegram chat and on the official r/BATproject subreddit.
            </CollectionBodyParagraph>
            ...
            <CollectionBodyParagraph>
                A few awesome companies and websites have already partnered with Brave to help bring a better web to life. Here are a few of them.
            </CollectionBodyParagraph>
            ...
            <CollectionBodyParagraph>
                If we want to help Brave fix the web, content creators are an important piece of the puzzle. A few big creators are already verified with Brave Rewards. Bart Baker and Philip DeFranco are two very successful YouTubers (10 million subscribers and 6.3 million subscribers respectively) who are Brave Rewards-verified.
            </CollectionBodyParagraph>
            <CollectionBodyParagraph>
                If you spend time in the official BAT Telegram chat, you’ll even see Bart Baker participating in conversations every now and then.
            </CollectionBodyParagraph>
            ...
            <CollectionBodyParagraph>
                All of these creators and companies are supporting this exciting new way of funding content online. Check them out, and send them some BAT to show them that they made a great choice in signing up for Brave Rewards!
            </CollectionBodyParagraph>
        </>
    )
}