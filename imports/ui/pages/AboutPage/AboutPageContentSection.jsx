            ...
            <ContentSectionBackground>
                <ContentSectionContainer>
                    ...
                    <AboutSection>
                        ...
                        <AboutBodyParagraph>
                            Some creators and publishers are already on board. We're finding the best ones and sharing them with you.
                        </AboutBodyParagraph>
                    </AboutSection>
                    <AboutSection>
                        <AboutHeader>What’s Brave? What’s BAT?</AboutHeader>
                        <AboutBodyParagraph>
                            Brave is a new browser that protects and respects you, and BAT is a new way to fund content online.
                        </AboutBodyParagraph>
                        <AboutBodyParagraph>
                            If you’ve ever had a website load slowly on your phone, had an annoying ad pop up in the middle of what you’re looking at, or been asked to sign up for a monthly subscription just to read a single article, then you understand how broken the web is today.
                        </AboutBodyParagraph>
                        <AboutBodyParagraph>
                            BAT will allow creators and publishers to make more money, advertisers to get better value for their money, and all internet users to get rewarded for their attention without having to give up their privacy. Everyone wins.
                        </AboutBodyParagraph>
                        <AboutBodyParagraph>
                            The people behind Brave and BAT are rockstars: pioneers of the web, leading voices on privacy regulation, extremely accomplished researchers, ad tech gurus, marketing masters, security and privacy trailblazers, and world-class engineers.
                        </AboutBodyParagraph>
                        <AboutBodyParagraph>
                            If you want to learn more about how the system works or why you should use Brave as your browser, here are some helpful links:
                        </AboutBodyParagraph>
                    </AboutSection>
                ...
                <ContentSectionContainer>
                    <AboutSection>
                        ...
                        <AboutBodyParagraph>
                            <AboutBodyBoldSpan>givebat</AboutBodyBoldSpan> is a curated directory of the best content creators who are leading the movement toward a better web.
                        </AboutBodyParagraph>
                        <AboutBodyParagraph>
                            We’re a small team who’s passionate about the better web that Brave is making possible.
                        </AboutBodyParagraph>
                        <AboutTeamContainer>
                            {/* Daniel */}
                            <AboutTeamMemberContainer target="_blank" href="https://danielcolinjames.com">
                            ...
                            {/* Evan */}
                            <AboutTeamMemberContainer target="_blank" href="http://evanfeng.me">
                            ...
                            {/* Shujun */}
                            <AboutTeamMemberContainer target="_blank" href="https://www.linkedin.com/in/shujun-bian-1b01b594/">
                            ...
                            {/* Felix */}
                            <AboutTeamMemberContainer target="_blank" href="https://www.linkedin.com/in/felix-h-b38ab9122/">
                    ...
                    <AboutSection>
                        ...
                        <AboutBodyParagraph>
                            Feature requests, suggestions, criticisms? We’d love to hear from you!
                        </AboutBodyParagraph>

                        <AboutSocialLinksContainer>

                            <AboutTwitterButton target="_blank" href="https://twitter.com/givebat">
