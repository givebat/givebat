  ...
  return (
    <>
      ...
      <FeaturedContentBodyParagraph>
        ...
        toward, and you might have seen him hanging around
        the <FeaturedContentBodyParagraphLinkText target="_blank"
                                                  href="https://reddit.com/r/BATproject">r/BATproject</FeaturedContentBodyParagraphLinkText> subreddit.
      </FeaturedContentBodyParagraph>
      <FeaturedContentBodyParagraph>
      ...
      <FeaturedContentBodyParagraph>
        ...
        follow <FeaturedContentBodyParagraphLinkText target="_blank"
                                                     href="https://instagram.com/sky_folk">@sky_folk
        on Instagram</FeaturedContentBodyParagraphLinkText>, subscribe
        to <FeaturedContentBodyParagraphLinkText target="_blank"
                                                 href="https://youtube.com/willchristiansen">Will’s
        YouTube channel</FeaturedContentBodyParagraphLinkText>, and go support
        them by sending some BAT their way!
      </FeaturedContentBodyParagraph>
    </>
  );
}